...
# MAGIC 
# MAGIC This notebook takes an existing neural network (INCEPTION-3) and applies it to a corpus of images.  This notebook requires that TensorFlow be installed on the cluster.
# MAGIC 
