...
// MAGIC %fs
// MAGIC ls /mnt/data/nyctaxi/scratchDir

// COMMAND ----------

// MAGIC %fs
// MAGIC mkdirs /mnt/data/nyctaxi/scratchDir/testDir/hiveTableTest
...
if (dbutils.fs.cp("file:/tmp/us_states.csv","/mnt/data/nyctaxi/scratchDir/testDir/hiveTableTest"))
  dbutils.fs.rm("file:/tmp/us_states.csv",recurse=true)


// COMMAND ----------

dbutils.fs.ls("/mnt/data/nyctaxi/scratchDir/testDir/hiveTableTest/")
