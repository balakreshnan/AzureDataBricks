...
// MAGIC %fs
// MAGIC mkdirs /mnt/data/nyctaxi/scratchDir

// COMMAND ----------

display(dbutils.fs.ls("/mnt/data/nyctaxi/scratchDir"))
...
dbutils.fs.cp("file:/tmp/If-By-Kipling.txt","/mnt/data/nyctaxi/scratchDir/testDir/")
...
display(dbutils.fs.ls("/mnt/data/nyctaxi/scratchDir/testDir"))
...
dbutils.fs.rm("/mnt/data/nyctaxi/scratchDir/testDir/If-By-Kipling-6.txt")
...
dbutils.fs.rm("/mnt/data/nyctaxi/scratchDir/testDir/",recurse=true)
