...
// MAGIC OPTIONS (
// MAGIC   url 'jdbc:sqlserver://dewdbsvr.database.windows.net:1433;database=dewdb;',
// MAGIC   dbtable 'BATCH_JOB_HISTORY',
// MAGIC   user 'sqladmin',
// MAGIC   password "Azure!2345"
// MAGIC );
...
//2) JDBC URL
val jdbcUrl = (s"jdbc:sqlserver://dewdbsvr.database.windows.net:1433;database=dewdb;user=sqladmin;password=Azure!2345")
