...
// MAGIC 
// MAGIC MLeap is a common serialization format and execution engine for machine learning pipelines. It supports Apache Spark, Scikit-learn, and TensorFlow for training pipelines and exporting them to an MLeap Bundle. Serialized pipelines (bundles) can be deserialized back into Apache Spark, Scikit-learn, TensorFlow graphs, or an MLeap pipeline. This notebook only demonstrates how to use MLeap to do the model export with MLlib. For an overview of the package and more examples, check out the [MLeap documentation](http://mleap-docs.combust.ml/).

// COMMAND ----------

// MAGIC %md ## Cluster Setup
// MAGIC 
// MAGIC 1. Create libraries with the Source ``Maven Coordinate`` and the fully-qualified Maven artifact coordinates:
// MAGIC    - `ml.combust.mleap:mleap-spark-base_2.11:0.10.1`     
// MAGIC    - `ml.combust.mleap:mleap-spark_2.11:0.10.1`
// MAGIC 1. Attach the libraries to a cluster.
// MAGIC 
// MAGIC **Note: **
